...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("Connecting to official Wolf server and analysing that img ...")
        try:
    ...
    if "image" in contentType:
        ...
        await event.edit("Removed dat annoying Backgroup in {} seconds, powered by Wolf Userbot".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @wolfuserbotOt Support Group\n`{}".format(output_file_name.content.decode("UTF-8")))
